...
/**
 Logs generated by CBLManager.
 
 @return A signal containing tuples (type, message) of log messages generated by CBLManager.
 @discussion Logging will be redirected to default when the signal is disposed.
 */
