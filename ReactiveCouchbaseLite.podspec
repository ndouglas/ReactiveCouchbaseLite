Pod::Spec.new do |s|
  ...
  s.source       		= { :git => "https://github.com/ndouglas/ReactiveCouchbaseLite.git", :tag => "1.0.20" }
  s.source_files  		= "*.{h,m}", "vendor/osx/CouchbaseLite.framework/Headers/*.h",  "vendor/osx/CouchbaseLiteListener.framework/Headers/*.h", 
