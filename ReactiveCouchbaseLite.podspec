Pod::Spec.new do |s|
  ...
  s.source       		= { :git => "https://github.com/ndouglas/ReactiveCouchbaseLite.git", :tag => "1.0.29" }
  ...
  s.ios.frameworks		= "CFNetwork.framework"
  s.ios.frameworks		= "Security.framework"
  s.ios.frameworks		= "libsqlite3.dylib"
  s.ios.frameworks		= "libz.dylib"
