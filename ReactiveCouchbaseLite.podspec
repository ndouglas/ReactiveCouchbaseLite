Pod::Spec.new do |s|
  ...
  s.source       		= { :git => "https://github.com/ndouglas/ReactiveCouchbaseLite.git", :tag => "1.0.7" }
  s.source_files  		= "*.{h,m}"
  s.exclude_files 		= "*.Tests.m", "RCLTestDefinitions.{h,m}"
  s.frameworks			= "Foundation"
  s.ios.frameworks		= "UIKit"
  s.osx.preserve_paths 		= "vendor/osx/CouchbaseLite.framework", "vendor/osx/CouchbaseLiteListener.framework", "RCLTestDefinitions.{h,m}", "*.Tests.m"
  s.ios.preserve_paths 		= "vendor/ios/CouchbaseLite.framework", "vendor/ios/CouchbaseLiteListener.framework", "RCLTestDefinitions.{h,m}", "*.Tests.m"
